...
export default function Register() {
  ...
  const stopRecording = async () => {
    try {
      ...
      const res = await fetch('https://66eb-223-181-107-136.ngrok-free.app//upload-User', {
        method: 'POST',
        body: formData,
      });
  ...
  const processRecording = async () => {
    try {
      const res = await fetch('https://66eb-223-181-107-136.ngrok-free.app//transcribeUser',{
      method:"GET",
      headers: {
  ...
  try {
    const res = await fetch('https://66eb-223-181-107-136.ngrok-free.app//register-speaker', {
      method: 'POST',
  ...
  if (!usersVisible) {
    try {
      const res = await fetch('https://66eb-223-181-107-136.ngrok-free.app//list-users',{
      method:"GET",
      headers: {
        "ngrok-skip-browser-warning": "true",  // ✅ correct spelling
        "Content-Type": "application/json"}
